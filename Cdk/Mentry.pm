...
sub new
{
   ...
   my $fieldwidth = Cdk::checkReq ($name, "Fwidth", $params{'Fwidth'});
   ...
   my $fillattr = Cdk::checkDef ($name, "Fillattr", $params{'Fillattr'}, "A_BOLD");
...
sub set
{
   ...
   my $min = Cdk::checkReq ($name, "Min", $params{'Min'});
   my $box = Cdk::checkDef ($name, "Box", $params{'Box'}, "TRUE");
